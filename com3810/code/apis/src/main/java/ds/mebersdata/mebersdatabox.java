...
public class mebersdatabox extends serverbox {
     ...
     *
     * */
    public mebersdatabox(HashMap<Integer, InetSocketAddress> clustermebers, int myid,InetSocketAddress ledradress) {
        super(clustermebers, myid);
    }

    /** this thread will only be runing iff its the leader
    ...
    /**
     *this will only be a thrad inefect if im the leader
    ...
    /**
     *
     *this will only be in efect iff this is a follower
     *
     *
    ...
    /**
     * this will only be inefect if the messge cam from the leader
    ...
    /**
     * this will be listening to the hart beat box to see iff leader is dead if it is start election if i win the election
     * i do an arp to make may self have the leading vip
     *
     */
    public void listenifleaderalive(){}
}
